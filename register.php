...
$stmt = $dbh->prepare("insert into users (name,email,mobile,password,Blood_Group,image) VALUES (:name, :email, :mobile, :password, :Blood_Group, :image)");
//bindParam
    ...
    <section class="login-content">
      ...
      <div class="login-box2">
        ...
        <form action="register.php"name="myform" method="post" class="login-form" enctype="multipart/form-data" onsubmit="validateform()">
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-users"></i> Receptionist Register</h3>
